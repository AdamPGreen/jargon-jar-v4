CREATE UNIQUE INDEX IF NOT EXISTS "jargon_terms_global_term_idx"
  ON "jargon_terms" (lower("term"))
  WHERE "workspace_id" IS NULL;

CREATE UNIQUE INDEX IF NOT EXISTS "jargon_terms_workspace_term_unique_idx"
  ON "jargon_terms" ("workspace_id", lower("term"))
  WHERE "workspace_id" IS NOT NULL;

INSERT INTO "jargon_terms" ("term", "description", "default_cost")
VALUES
  ...
  ('Game Changer', 'Minor feature competitors already have', 2.50),
  ...
  ('Robust', 'Unnecessarily complicated', 1.50),
