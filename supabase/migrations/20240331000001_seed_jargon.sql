-- Insert common corporate jargon terms from docs/jargon-dictionary.md (final list)
-- Note: These will be inserted with workspace_id as NULL to make them global terms
